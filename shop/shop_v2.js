...
function getProducts() {
  return [
    ...
    { id: 'prod_notion', type: 'digital', price: 9.99, icon: 'book', image: '../stoicisme-modern.jpg', titleFr: 'Journal Notion Stoïcien', titleEn: 'Stoic Notion Journal', titleAr: 'مفكرة Notion الرواقية', descFr: 'Un espace structuré pour vos bilans matin/soir et le suivi de vos vertus quotidiennes.', descEn: 'A structured space for morning/evening reviews and tracking daily virtues.', descAr: 'مساحة منظمة لمراجعاتك الصباحية والمسائية وتتبع فضائلك اليومية.' },
    { id: 'prod_wallpaper', type: 'digital', price: 4.99, icon: 'image', image: '../carl-jung-shadow.jpg', titleFr: 'Pack de Fonds d\'écran Sagesse', titleEn: 'Wisdom Wallpaper Pack', titleAr: 'حزمة خلفيات الحكمة للهاتف', descFr: '15 designs minimalistes haute définition avec citations inspirantes pour votre téléphone.', descEn: '15 high-definition minimalist designs with inspiring quotes for your phone.', descAr: '15 تصميماً بسيطاً عالي الدقة مع حكم ملهمة لشاشة هاتفك الذكي.' },
    { id: 'prod_coin', type: 'physical', price: 14.99, icon: 'award', image: '../avatar.jpg', titleFr: 'Pièce Memento Mori Bronze', titleEn: 'Bronze Memento Mori Coin', titleAr: 'عملة تذكر الموت البرونزية', descFr: 'Une pièce physique lourde gravée à garder en poche pour se rappeler la valeur du temps.', descEn: 'A heavy physical engraved coin to keep in pocket as a reminder of time\'s value.', descAr: 'عملة معدنية برونزية ثقيلة ومحفورة لحملها in جيبك كتذكار دائم بقيمة الوقت.' },
    { id: 'prod_posters', type: 'physical', price: 19.99, icon: 'film', image: '../thinkers/images/marcaurele.jpg', titleFr: 'Affiche Marc Aurèle Fine-Art', titleEn: 'Marcus Aurelius Fine-Art Poster', titleAr: 'لوحة ماركوس أوريليوس الكلاسيكية', descFr: 'Impression d\'art sur papier de qualité musée (30x40cm) au fini mat texturé.', descEn: 'Museum-quality fine art print (30x40cm) with textured matte finish.', descAr: 'لوحة فنية مطبوعة على ورق فاخر بجودة المتاحف (30x40 سم) بلمس مطفأ.' }
  ];
}
    ...
    return `
      <div class="product-card">
        ...
        <div class="product-footer-row" style="margin-top: auto; display: flex; justify-content: space-between; align-items: center; width: 100%;">
          ...
          <button class="${btnClass}" data-id="${prod.id}" data-file="${fileName}">
            ${btnIcon}
            <span>${btnLabel}</span>
          </button>
        </div>
