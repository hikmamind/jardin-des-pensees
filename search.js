...
(function () {
  ...
  const searchIndex = [
    ...
    {
      title: "رسائل إلى ميلينا (Briefe an Milena)",
      author: "فرانز كافكا",
      type: "audio",
      typeName: "كتاب صوتي",
      url: "./audio/?book=milena",
      img: "./audio_milena_cover.jpg",
      desc: "رسائل العشق والشغف والحيرة العميقة بين فرانز كافكا وميلينا ييسينسكا.",
      keywords: ["رسائل إلى ميلينا", "ميلينا", "كافكا", "kafka", "milena", "رسائل", "حب", "صوتي"]
    },
