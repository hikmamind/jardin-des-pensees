const TIKTOK_DATA = {
  ...
  content: {
    fr: {
      ...
      quotes: [
        { text: "Ce qui trouble les hommes, ce ne sont pas les choses, mais les jugements qu'ils portent sur les choses.", author: "Épictète (Stoïcisme)", image: "thinkers/images/epictete.jpg" },
        { text: "Une vie sans examen ne vaut pas la peine d'être vécue.", author: "Socrate (Philosophie)", image: "thinkers/images/socrate.jpg" },
        { text: "La vie est comme une pièce de théâtre : ce qui importe, ce n'est pas qu'elle dure longtemps, mais qu'elle soit bien jouée.", author: "Sénèque (Philosophie)", image: "thinkers/images/seneque.jpg" },
        { text: "Celui qui a un pourquoi dans la vie peut supporter presque n'importe quel comment.", author: "Friedrich Nietzsche", image: "thinkers/images/nietzsche.jpg" },
        { text: "Je ne suis pas ce qui m'est arrivé, je suis ce que je choisis de devenir.", author: "Carl Jung (Psychologie)", image: "thinkers/images/jung.jpg" },
        { text: "Le bonheur de votre vie dépend de la qualité de vos pensées.", author: "Marc Aurèle (Stoïcisme)", image: "thinkers/images/marcaurele.jpg" }
      ],
      advices: [
        ...
        questions: [
          {
            ...
            options: [
              { text: "Je me concentre sur ce que je peux contrôler et j'accepte le reste sereinement.", profile: "stoic" },
              { text: "Je souris face à l'absurdité du chaos et j'en profite pour improviser ma liberté.", profile: "absurd" },
              { text: "Je ressens une frustration profonde, sachant que la vie est par nature pleine d'entraves.", profile: "existential" }
            ]
          },
          {
            id: 2,
            ...
            options: [
              { text: "Agir avec vertu, maîtriser mes passions et aider activement la communauté.", profile: "stoic" },
              { text: "Vivre intensément, me révolter contre l'insensé et savourer ma liberté.", profile: "absurd" },
              { text: "Mieux me comprendre, m'élever par la création et surmonter mes ombres.", profile: "existential" }
            ]
          },
          {
            id: 3,
            ...
            options: [
              { text: "Ils ne m'atteignent pas. L'opinion des autres ne dépend pas de ma volonté.", profile: "stoic" },
              { text: "C'est une scène de théâtre. Je reste libre de jouer ma propre partition.", profile: "absurd" },
              { text: "Ils me poussent à une introspection rigoureuse pour renforcer mon esprit.", profile: "existential" }
            ]
          },
          {
            id: 4,
            ...
            options: [
              { text: "La paix de l'esprit commence là où s'arrête la vaine tentative de tout contrôler.", profile: "stoic" },
              { text: "Il n'y a pas de destin que le mépris ou la révolte joyeuse ne puisse surmonter.", profile: "absurd" },
              { text: "Ce qui ne me détruit pas me rend infiniment plus fort et plus conscient.", profile: "existential" }
            ]
          },
          {
            id: 5,
            ...
            options: [
              { text: "Je l'accepte et je l'utilise comme carburant pour forger ma vertu.", profile: "stoic" },
              { text: "Je l'affronte avec défi, sans jamais lui accorder le pouvoir de me soumettre.", profile: "absurd" },
              { text: "Je l'exprime à travers l'introspection, l'art ou la contemplation créative.", profile: "existential" }
            ]
          }
        ],
        profiles: {
          stoic: {
            ...
            desc: "Votre âme résonne avec Marc Aurèle et Sénèque. Vous possédez une force intérieure qui puise sa source dans la clarté mentale et la distinction entre ce que vous maîtrisez et ce que vous subissez. Votre résilience face aux tempêtes de la vie est votre plus grand atout.",
            recomThinkers: ["marcaurele", "seneque", "epictete"],
            recomCategory: "philosophy"
          },
          absurd: {
            title: "L'Absurdisme (La Révolte Lumineuse)",
            desc: "Vous êtes dans la lignée directe d'Albert Camus. Vous refusez d'abandonner votre liberté face au silence et à l'absurdité du monde. Vous transformez le manque de sens prédéfini en une liberté créatrice totale et une passion dévorante pour l'existence.",
            recomThinkers: ["camus"],
            recomCategory: "philosophy"
          },
          existential: {
            title: "L'Existentialisme / Le Pessimisme Lucide",
            desc: "Vous partagez les vues de Friedrich Nietzsche et Arthur Schopenhauer. Pour vous, la vie est une aventure d'auto-dépassement et de lucidité psychologique. Vous acceptez les ombres de la condition humaine pour mieux les intégrer et forger votre propre liberté spirituelle.",
            recomThinkers: ["nietzsche", "schopenhauer", "jung"],
    ...
    en: {
      ...
      quotes: [
        { text: "Men are disturbed not by things, but by the views which they take of things.", author: "Epictetus (Stoicism)", image: "thinkers/images/epictete.jpg" },
        { text: "The unexamined life is not worth living.", author: "Socrates (Philosophy)", image: "thinkers/images/socrate.jpg" },
        { text: "Life is like a play: what matters is not how long it lasts, but how well it is acted.", author: "Seneca (Philosophy)", image: "thinkers/images/seneque.jpg" },
        { text: "He who has a why to live can bear almost any how.", author: "Friedrich Nietzsche", image: "thinkers/images/nietzsche.jpg" },
        { text: "I am not what happened to me, I am what I choose to become.", author: "Carl Jung (Psychology)", image: "thinkers/images/jung.jpg" },
        { text: "The happiness of your life depends upon the quality of your thoughts.", author: "Marcus Aurelius (Stoicism)", image: "thinkers/images/marcaurele.jpg" }
      ],
      advices: [
      ...
      quiz: {
        questions: [
          {
            id: 1,
            question: "Facing a stressful setback (e.g., cancelled flight, computer crash), what is your first reaction?",
            options: [
              { text: "I focus on what is within my control and accept the rest calmly.", profile: "stoic" },
              { text: "I smile at the absurdity of chaos and take it as a chance to improvise.", profile: "absurd" },
              { text: "I feel deep frustration, knowing life is inherently full of obstacles.", profile: "existential" }
            ]
          },
          {
            id: 2,
            question: "For you, what is the ultimate goal of your life on Earth?",
            options: [
              { text: "To act with virtue, master my passions, and actively serve the community.", profile: "stoic" },
              { text: "To live intensely, rebel against meaninglessness, and enjoy absolute freedom.", profile: "absurd" },
              { text: "To understand myself deeply, transcend suffering, and create my own values.", profile: "existential" }
            ]
          },
          {
            id: 3,
            question: "How do you react to criticism or other people's opinions of you?",
            options: [
              { text: "They do not affect me. What others think is outside my sphere of control.", profile: "stoic" },
              { text: "It is just a social play. I remain free to play my own role.", profile: "absurd" },
              { text: "They push me into a deep self-examination to better integrate my shadow.", profile: "existential" }
            ]
          },
          {
            id: 4,
            question: "Which outlook or statement aligns best with your mind?",
            options: [
              { text: "Peace of mind starts where the futile attempt to control everything ends.", profile: "stoic" },
              { text: "There is no fate that cannot be surmounted by scorn or cheerful revolt.", profile: "absurd" },
              { text: "What does not kill me makes me infinitely stronger and more aware.", profile: "existential" }
            ]
          },
          {
            id: 5,
            question: "Faced with an inevitable hardship or pain, how do you respond?",
            options: [
              { text: "I accept it and use it as fuel to forge my character and virtue.", profile: "stoic" },
              { text: "I confront it with defiance, refusing to let it break my passion.", profile: "absurd" },
              { text: "I express it through introspection, creative arts, or deep reflection.", profile: "existential" }
            ]
          }
        ],
        profiles: {
          stoic: {
            title: "Stoicism (The Inner Citadel)",
            desc: "Your soul aligns with Marcus Aurelius and Seneca. You possess an inner strength that distinguishes clearly between what you control and what you do not. Your resilience is your shield.",
            recomThinkers: ["marcaurele", "seneque", "epictete"],
            recomCategory: "philosophy"
          },
          absurd: {
            title: "Absurdism (The Radiant Revolt)",
            desc: "You walk the path of Albert Camus. You embrace the meaninglessness of the universe not with despair, but with a passionate demand for absolute freedom and rebellion.",
            recomThinkers: ["camus"],
            recomCategory: "philosophy"
          },
          existential: {
            title: "Existentialism / Lucide Pessimism",
            desc: "You share views with Friedrich Nietzsche and Arthur Schopenhauer. Life is a path of self-overcoming and creative transcendence of suffering. You face the abyss to grow stronger.",
            recomThinkers: ["nietzsche", "schopenhauer", "jung"],
            recomCategory: "development"
          }
        }
    ...
    ar: {
      ...
      quotes: [
        { text: "ما يقلق الناس ليس الأشياء في حد ذاتها، بل الأحكام التي يطلقونها عليها.", author: "إبيكتيتوس (الرواقية)", image: "thinkers/images/epictete.jpg" },
        { text: "الحياة غير المفحوصة لا تستحق العيش.", author: "سقراط (الفلسفة)", image: "thinkers/images/socrate.jpg" },
        { text: "الحياة مثل المسرحية: لا يهم طولها بل كيف تم تأديتها.", author: "سينيكا (الفلسفة)", image: "thinkers/images/seneque.jpg" },
        { text: "من يملك 'لماذا' يعيش من أجلها، يمكنه تحمل أي 'كيف' تقريباً.", author: "فريدريك نيتشه", image: "thinkers/images/nietzsche.jpg" },
        { text: "أنا لست ما حدث لي، أنا ما أختار أن أكونه.", author: "كارل يونغ (علم النفس)", image: "thinkers/images/jung.jpg" },
        { text: "سعادة حياتك تعتمد على جودة أفكارك.", author: "ماركوس أوريليوس (الرواقية)", image: "thinkers/images/marcaurele.jpg" }
      ],
      advices: [
      ...
      quiz: {
        questions: [
          {
            id: 1,
            question: "عند مواجهتك لعقبة مفاجئة ومقلقة (مثل إلغاء رحلة أو عطل حاسوب مفاجئ)، ما هو أول رد فعل لك؟",
            options: [
              { text: "أركز بالكامل على ما يقع تحت سيطرتي المباشرة وأتقبل الباقي بهدوء ورضا.", profile: "stoic" },
              { text: "أبتسم أمام عبثية الفوضى وأستغل الموقف لارتجال حريتي وعيش اللحظة.", profile: "absurd" },
              { text: "أشعر بإحباط عميق وضيق، مدركاً أن الحياة بطبيعتها مليئة بالعقبات والمنغصات.", profile: "existential" }
            ]
          },
          {
            id: 2,
            question: "بالنسبة لك، ما هو الهدف الأسمى والأهم من وجودك في هذه الحياة؟",
            options: [
              { text: "العمل بفضيلة وأخلاق، والسيطرة على أهوائي، وتقديم العون لمجتمعي.", profile: "stoic" },
              { text: "العيش بشغف وقوة، والتمرد ضد عبثية العدم، والاستمتاع بحريتي الفردية.", profile: "absurd" },
              { text: "فهم نفسي بعمق، والارتقاء من خلال الفن والإبداع، وتجاوز نقاط ضعفي وظلالي.", profile: "existential" }
            ]
          },
          {
            id: 3,
            question: "كيف تتعامل مع انتقادات الآخرين أو نظرتهم وتقييمهم لك؟",
            options: [
              { text: "لا تؤثر فيّ على الإطلاق؛ فنظرة الناس وأحكامهم تقع خارج نطاق تحكمي وإرادتي.", profile: "stoic" },
              { text: "أعتبرها مجرد مشهد في مسرحية اجتماعية كبرى، وأبقى حراً تماماً في تمثيل دوري الخاص.", profile: "absurd" },
              { text: "تدفعني إلى مراجعة ذاتية دقيقة ونقد داخلي صارم لفهم أبعادي النفسية وتكاملها.", profile: "existential" }
            ]
          },
          {
            id: 4,
            question: "أي من القناعات التالية تعبر بشكل أفضل عن فلسفتك وطريقتك في التفكير؟",
            options: [
              { text: "تبدأ طمأنينة الروح عندما تتوقف عن محاولاتك اليائسة للتحكم بكل شيء.", profile: "stoic" },
              { text: "لا يوجد مصير أو صعوبة لا يمكن التغلب عليها بالتمرد الفكري السعيد والساخر.", profile: "absurd" },
              { text: "كل ما لا يقتلني ويقضي عليّ، يجعلني في النهاية أقوى بكثير وأكثر وعياً بذاتي.", profile: "existential" }
            ]
          },
          {
            id: 5,
            question: "عندما تواجه ألماً شديداً أو محنة قاسية، كيف تتعامل معها؟",
            options: [
              { text: "أتقبلها بصدر رحب وأحاول استغلالها كفرصة وتدريب لصقل أخلاقي وقوتي النفسية.", profile: "stoic" },
              { text: "أواجهها بتحدٍ وشجاعة، رافضاً تماماً أن أمنحها القدرة على كسر إرادتي وشغفي.", profile: "absurd" },
              { text: "أعبر عنها بالتدوين أو التأمل والموسيقى، محولاً الألم إلى طاقة وعي وإبداع.", profile: "existential" }
            ]
          }
        ],
        profiles: {
          stoic: {
            title: "الفلسفة الرواقية (قلعة العقل الداخلية)",
            desc: "تتلاقى روحك وتفكيرك مع الفلاسفة الكبار مثل ماركوس أوريليوس وسينيكا وإبيكتيتوس. أنت تمتلك قوة داخلية تنبع من التمييز الواضح بين ما يمكنك تغييره وما يجب عليك قبوله. صلابتك أمام تقلبات الحياة هي أعظم درع تحمله.",
            recomThinkers: ["marcaurele", "seneque", "epictete"],
            recomCategory: "philosophy"
          },
          absurd: {
            title: "الفلسفة العبثية (التمرد المشرق)",
            desc: "أنت تسير على خطى الكاتب والفيلسوف ألبير كامو. ترفض الاستسلام لغياب المعنى المسبق في الكون، بل تجعل من هذا الصمت دافعاً للحرية المطلقة وعيش حياتك بشغف عارم وتحدٍ مستمر.",
            recomThinkers: ["camus"],
            recomCategory: "philosophy"
          },
          existential: {
            title: "الوجودية / التشاؤمية الواعية",
            desc: "أنت تشارك فريدريك نيتشه وأرتور شوبنهاور وكارل يونغ نظرتهما للوجود. بالنسبة لك، تمثل الحياة مساراً مستمراً لتجاوز الذات وتطوير الوعي النفسي. أنت لا تخشى مواجهة الجوانب المظلمة لتصنع منها حريتك وقوتك الفريدة.",
            recomThinkers: ["nietzsche", "schopenhauer", "jung"],
            recomCategory: "development"
          }
        }
