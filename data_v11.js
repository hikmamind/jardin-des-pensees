const TIKTOK_DATA = {
  ...
  "ui": {
    ...
    "ar": {
      ...
      "cardTitle4": "حكم وأقوال خالدة من عظماء الفكر",
    ...
    "fr": {
      ...
      "articles": [
        ...
        },
        {
          ...
          "desc": "Un guide approfondi sur la façon dont la philosophie stoïcienne antique offre des outils pour développer une force mentale face aux épreuves.",
          "body": [
        ...
        {
          "category": "philosophy",
          "file": "introduction-stoicisme.html",
          "image": "stoicisme-modern.jpg",
          "featured": true,
        ...
        {
          "category": "philosophy",
          "file": "20-citations-schopenhauer.html",
          "image": "thinkers/images/schopenhauer.jpg",
          "featured": true,
          "title": "20 Citations d'Arthur Schopenhauer",
          "readTime": "15 min read",
          "desc": "E-book complet contenant 20 citations phares d'Arthur Schopenhauer avec explications, leçons et questions de réflexion.",
          "body": [
            "Nous sommes fiers de vous présenter ce guide philosophique complet sous forme d'E-book téléchargeable. Ce recueil réunit 20 des plus célèbres et profondes pensées d'Arthur Schopenhauer, commentées et analysées.",
            "Pour chaque citation, vous trouverez :",
            "1. Le texte de la citation en gros caractères.",
            "2. Une explication philosophique approfondie reliant la pensée à la théorie de la Volonté.",
            "3. Une leçon de vie pratique pour cultiver votre lucidité psychologique au quotidien.",
            "4. Une question d'introspection pour entamer un dialogue avec vous-même.",
            "Vous pouvez télécharger cet ouvrage au format Word (.docx) en cliquant ci-dessous, ou l'ajouter gratuitement à votre panier dans la boutique."
          ]
        }
      ],
      "faq": [
    ...
    "en": {
      ...
      "articles": [
        ...
        },
        {
          ...
          "readTime": "8 min read",
          "desc": "How 1% daily shifts accumulate to transform your actions, results, and identity.",
          "body": [
        ...
        },
        {
          ...
          "image": "thinkers/images/schopenhauer.jpg",
          "featured": true,
          "title": "20 Quotes of Arthur Schopenhauer",
          "readTime": "15 min read",
          "desc": "Full Ebook containing 20 core quotes by Arthur Schopenhauer with explanations, lessons, and reflections.",
          "body": [
            "We are pleased to offer this philosophical ebook to our readers. It gathers 20 of the most profound and mature quotes by Arthur Schopenhauer, with clear commentary.",
            "Each page is structured around four sections:",
            "1. The original quote text in bold.",
            "2. A detailed philosophical explanation linking the quote to the Will-to-live.",
            "3. A practical daily lesson for personal growth and mental clarity.",
            "4. A reflective question for self-examination.",
            "Download this full guide as a Microsoft Word (.docx) document below, or grab it for free in our shop."
          ]
        }
      ],
      "faq": [
    ...
    "ar": {
      ...
      "articles": [
        ...
        },
        {
          ...
          "desc": "خطوات وتمارين عملية وواضحة لدمج الحكمة الرواقية في روتينك اليومي للتغlb على القلق وتطوير الذات.",
          "body": [
            "لم تُصمم الفلسفة الرواقية لتكون مادة للجدل في قاعات الجامعات، بل لتكون ممارسة حية في شوارع المدن وفي أعماق الضمير الإنساني. في عصرنا الحالي المليء بالقلق والتشتت الرقمي والضغوط المستمرة، تقدم الرواقية دليلاً عملياً لحماية توازننا النفسي. يستعرض this الدليل ثلاثة تمارين رواقية أساسية وسهلة التطبيق لدمجها في جدولك اليومي وتغيير جودة حياتك.",
        ...
        },
        {
          ...
          "image": "thinkers/images/schopenhauer.jpg",
          "featured": true,
          "title": "20 اقتباساً لآرثر شوبنهاور",
          "readTime": "دقيقة قراءة 15",
          "desc": "كتاب إلكتروني كامل يحتوي على 20 اقتباساً مختارة من أعمق ما قاله شوبنهاور مع الشرح والدروس والتأملات.",
          "body": [
            "يسرنا أن نقدم لكم هذا العمل الفلسفي المتكامل كهدية لقرائنا ومتابعينا على حساب 'حكمة ونور'. يجمع هذا الكتاب الإلكتروني 20 اقتباساً من أعمق وأهم ما خطه قلم الفيلسوف الألماني أرتور شوبنهاور، رائد الفلسفة التشاؤمية الواعية.",
            "مقدمة | رحلة في عمق الفكر الإنساني",
            "لسنا معذبين بالأشياء نفسها، بل برؤيتنا للأشياء. - آرثر شوبنهاور",
            "لماذا شوبنهاور؟",
            "آرثر شوبنهاور (1788-1860) هو أحد أكثر الفلاسفة عمقاً وصدقاً في تاريخ الفكر الإنساني. لم يكن فيلسوفاً يبحث عن الشهرة أو المجد، بل كان مفكراً وحيداً، تأمل الحياة بعيون نافذة، ورأى ما لا يريد الكثيرون رؤيته: أن الألم جزء لا يتجزأ من الوجود الإنساني، وأن السعادة ليست سوى لحظات نادرة من غياب هذا الألم.",
            "--- اقتباس رقم 01 ---",
            "\"الحياة تتأرجح كالبندول إلى الأمام وإلى الخلف بين الألم، والملل.\"",
            "✒️ الشرح : يرى شوبنهاور أن حياتنا محكومة بحركتين أساسيتين: الألم عندما تسيطر علينا الرغبة ولا نمتلك ما نريد، والملل عندما نحقق ما نريد فتزول الرغبة ويحل الفراغ. بين هذين القطبين ندور دون أن نجد سكوناً حقيقياً.",
            "☀️ الدرس المستخلص : لا تنتظر حياة خالية من الألم أو الملل. بل تعلم كيف تجعل وعيك أعمق من هذه التأرجحات السطحية.",
            "❓ سؤال للتأمل : هل أنت أسير البحث عن شيء جديد، أم أنك تعرف كيف تجد معنى حتى في لحظات الفراغ؟",
            "--- اقتباس رقم 02 ---",
            "\"السعادة ليست إلا غياب الألم\"",
            "✒️ الشرح : يرى شوبنهاور أن حياتنا تتأرجح بين الألم والرغبة. فنحن نعيش في حالة من النقص والاحتياج الدائم، وما نسميه 'سعادة' ليس سوى لحظة قصيرة يتوقف فيها الألم أو تزول الرغبة مؤقتاً. لذلك، لا ينبغي أن نبحث عن السعادة في تحقيق المزيد، بل في تقدير لحظات السكون والرضا التي يشبهها هذا العالم.",
            "☀️ الدرس المستخلص : لا تربط سعادتك بما لا تملك، بل بتقدير ما لا يؤلمك الآن.",
            "❓ سؤال للتأمل : هل تربط سعادتك دائماً بتحقيق المزيد من الرغبات، أم بتقدير اللحظات التي لا يؤلمك فيها شيء؟",
            "--- اقتباس رقم 03 ---",
            "\"لا يمكن للمرء أن يكون نفسه إلا عندما يكون وحيداً؛ فمن لا يحب العزلة لا يحب الحرية.\"",
            "✒️ الشرح : يرى شوبنهاور أن المجتمع يفرض علينا ارتداء الأقنعة لنتوافق مع الآخرين، مما يجعلنا نفقد أصالتنا. في العزلة فقط، يمكننا التخلص من هذه الأقنعة ونكون حقيقتنا، مما يمنحنا الحرية الفكرية والروحية التامة.",
            "☀️ الدرس المستخلص : لا تخش العزلة، بل احتضنها كفرصة لاكتشاف ذاتك الحقيقية. اجعل من خلوتك مساحة لبناء استقلاليتك الفكرية وقوتك الداخلية، بدلاً من البحث عن التحقق من الآخرين.",
            "❓ سؤال للتأمل : عندما تجلس بمفردك تماماً، هل تشعر بالسلام والحرية أم بالقلق والحاجة للهروب؟ وكيف يمكنك تحويل أوقات عزلتك إلى مساحة للنمو؟",
            "--- اقتباس رقم 04 ---",
            "\"كل صبي ذكي هو عبقري محتمل، وكل رجل غبي هو طفل لم يكتمل نموه.\"",
            "✒️ الشرح : يشير شوبنهاور إلى أن الطفولة تتميز بالدهشة والفضول وحب المعرفة المطلق، وهي سمات العبقرية. بينما البالغ الغبي يفقد هذه الدهشة دون اكتساب نضج حقيقي.",
            "☀️ الدرس المستخلص : حافظ على فضول الطفولة ودهشتها كبوابة للإبداع والتعلم المستمر.",
            "❓ سؤال للتأمل : متى كانت آخر مرة شعرت فيها بالدهشة الخالصة تجاه أمر بسيط في العالم؟",
            "--- اقتباس رقم 05 ---",
            "\"العقل هو مجرد وكيل لإرادة الحياة.\"",
            "✒️ الشرح : يرى شوبنهاور أن عقولنا لا تقودنا بشكل عقلاني تماماً، بل هي أدوات طيعة تخدم 'الإرادة' (الغرائز والرغبة العميقة في البقاء والتكاثر).",
            "☀️ الدرس المستخلص : كن واعيًا بدوافعك العميقة؛ فكثير من التبريرات العقلانية هي مجرد غطاء لغرائز ورغبات خفية.",
            "❓ سؤال للتأمل : هل قراراتك الأخيرة نابعة من تفكير عقلاني حقيقي، أم أنها تبرير لرغبة عاطفية ملحة؟",
            "--- اقتباس رقم 06 ---",
            "\"الثروة مثل ماء البحر; كلما شربت منها زاد عطشك، وكذلك الشهرة.\"",
            "✒️ الشرح : المطامع المادية لا تشبع أبداً لأن تحقيق الرغبة لا ينهي التوق، بل يفتح الباب لرغبات أكبر وأكثر تطلباً.",
            "☀️ الدرس المستخلص : ابحث عن القناعة الداخلية والتحرر من عبودية الاستهلاك اللانهائي.",
            "❓ سؤال للتأمل : ما هو الشيء الذي تظن أنك بحاجة إليه لتسعد، وهل سيمنحك حقاً سلاماً دائماً؟",
            "--- اقتباس رقم 07 ---",
            "\"كل صديق هو مرآة تعكس جزءاً من هويتنا، وإلا لمللنا منه سريعاً.\"",
            "✒️ الشرح : نحن ننجذب لمن يشبهوننا أو يعبرون عن جوانب نقدّرها في أنفسنا. العلاقات الإنسانية هي مرآة لوعينا الذاتي.",
            "☀️ الدرس المستخلص : اختر أصدقاءك بعناية، لأنهم يعكسون من أنت ويؤثرون في نموك النفسي.",
            "❓ سؤال للتأمل : ما الذي تعكسه علاقاتك الحالية عن صفاتك الداخلية وقيمك؟",
            "--- اقتباس رقم 08 ---",
            "\"أكبر الأخطاء هو التضحية بالصحة من أجل أي شيء آخر، سواء كان الثروة، أو الشهرة، أو العلم.\"",
            "✒️ الشرح : بدون صحة الجسد والنفس، لا يمكن الاستمتاع بأي إنجاز أو متعة مادية. الصحة هي القاعدة التي يُبنى عليها الوجود.",
            "☀️ الدرس المستخلص : ضع سلامتك الجسدية والنفسية فوق كل اعتبار ومكسب خارجي مؤقت.",
            "❓ سؤال للتأمل : هل تهمل جسدك وراحتك النفسية في سبيل تحقيق أهداف مادية أو مهنية؟",
            "--- اقتباس رقم 09 ---",
            "\"الأصدقاء يصفون أنفسهم بأنهم مخلصون، لكن الأعداء هم المخلصون حقاً؛ فمنهم تعرف الحقيقة كاملة.\"",
            "✒️ الشرح : النقد الصادق والقاسي غالباً ما يأتي من الخصوم الذين لا يجاملون، بينما الأصدقاء قد يخفون الحقيقة تجنباً لإيذاء المشاعر.",
            "☀️ الدرس المستخلص : لا تنزعج من نقد أعدائك، بل استخدمه كمرآة كاشفة لتصحيح عيوبك الحقيقية.",
            "❓ سؤال للتأمل : كيف يمكنك تحويل هجمات ونقد الآخرين إلى دروس لبناء قوتك وتطوير ذاتك؟",
            "--- اقتباس رقم 10 ---",
            "\"الموت هو المعلم الحقيقي للحياة، وبدونه لما كان هناك فلسفة.\"",
            "✒️ الشرح : حتمية الموت والوعي بالفناء هما الدافعان الأساسيان وراء بحث الإنسان عن المعنى وفهم طبيعة الوجود.",
            "☀️ الدرس المستخلص : تذكر الموت ليس كدعوة للاستسلام، بل كحافز لعيش كل يوم بوعي وعمق.",
            "❓ سؤال للتأمل : كيف تتغير أولوياتك اليومية إذا تذكرت أن وقتك في هذا العالم محدود؟",
            "--- اقتباس رقم 11 ---",
            "\"ما يملكه الإنسان في نفسه هو ما يحدد سعادته، وليس ما يملكه في يديه.\"",
            "✒️ الشرح : العالم الداخلي (الأفكار، المشاعر، المعرفة) هو المصدر الحقيقي للرضا، بينما الممتلكات الخارجية زائلة ولا تملأ الفراغ الروحي.",
            "☀️ الدرس المستخلص : استثمر في عقلك وروحك؛ فثروتك الحقيقية هي ما تحمله في داخلك.",
            "❓ سؤال للتأمل : لو جردت من كل ممتلكاتك المادية اليوم، ما الذي يتبقى منك ويسعدك؟",
            "--- اقتباس رقم 12 ---",
            "\"العبقرية تسدد هدفاً لا يمكن لأحد رؤيته، أما الموهبة فتسدد هدفاً لا يمكن لأحد إصابته.\"",
            "✒️ الشرح : الموهوب يفعل ما يراه الجميع بشكل أفضل، أما العبقري فيأتي بأفكار ورؤى سابقة لعصره تماماً لا يستطيع الآخرون حتى تخيلها.",
            "☀️ الدرس المستخلص : ثق برؤيتك الفريدة ولا تخش السير في طرق غير مألوفة، حتى لو لم يفهمك الآخرون.",
            "❓ سؤال للتأمل : هل تمتلك فكرة أو شغفاً تخشى التعبير عنه لمجرد أنه يختلف عن السائد؟",
            "--- اقتباس رقم 13 ---",
            "\"من الصعب جداً العثور على السعادة في أنفسنا، ومن المستحيل العثور عليها في أي مكان آخر.\"",
            "✒️ الشرح : البحث عن السعادة في الظروف الخارجية أو الأشخاص الآخرين وهم يؤدي للخيبة. السلام يبدأ وينتهي في العقل.",
            "☀️ الدرس المستخلص : توقف عن البحث في الخارج، وركز على تصالحك مع ذاتك وتهدئة اضطراباتك الداخلية.",
            "❓ سؤال للتأمل : أين تبحث عن السعادة في أغلب الأوقات: في إنجازاتك وعلاقاتك، أم في سكينتك الداخلية؟",
            "--- اقتباس رقم 14 ---",
            "\"يمكن للكلب أن ينظر إلى الملك، ولكن هذا لا يجعله يفهم معنى الملكية.\"",
            "✒️ الشرح : كل شخص يدرك العالم على قدر وعيه وفهمه فقط؛ العقول الضيقة لا يمكنها استيعاب الأفكار العميقة مهما بلغت بساطتها.",
            "☀️ الدرس المستخلص : لا تضيع وقتك في شرح أفكارك العميقة لمن لا يملك القدرة الروحية أو العقلية لاستيعابها.",
            "❓ سؤال للتأمل : هل ترهق نفسك بمحاولة إقناع أشخاص لا يريدون أو لا يستطيعون فهم وجهة نظرك؟",
            "--- اقتباس رقم 15 ---",
            "\"التسامح مع الحماقة هو قناع للجبن والخوف من المواجهة.\"",
            "✒️ الشرح : السكوت عن الخطأ والتظاهر بالرضا لمجرد تجنب النزاع يضعف الشخصية ويفقد الإنسان احترامه لذاته.",
            "☀️ الدرس المستخلص : تعلم كيف تقول 'لا' وتضع حدوداً واضحة لحماية سلامك النفسي ومبادئك.",
            "❓ سؤال للتأمل : في أي المواقف تتنازل عن مبادئك وتصمت تجنباً للمواجهة أو الخلاف؟",
            "--- اقتباس رقم 16 ---",
            "\"المهارة في كتمان الأسرار هي أولى خطوات النضج والنجاح.\"",
            "✒️ الشرح : البوح بكل شيء يفقدك الغموض ويجعلك مكشوفاً وتسهل السيطرة عليك؛ الاحتفاظ بخصوصيتك يحمي خططك وأهدافك.",
            "☀️ الدرس المستخلص : اجعل أهدافك الكبرى وخصوصياتك طي الكتمان حتى تتحقق على أرض الواقع.",
            "❓ سؤال للتأمل : هل تشعر برغبة ملحة دائماً في مشاركة كل تفاصيل حياتك وأهدافك مع الآخرين؟",
            "--- اقتباس رقم 17 ---",
            "\"الشرف لا يُكتسب، بل يجب فقط ألا يُفقد.\"",
            "✒️ الشرح : يولد الإنسان حراً شريفاً بطبيعته، والأفعال السيئة والدناءة هي ما تلطخ هذا الشرف وتفقده احترامه لنفسه.",
            "☀️ الدرس المستخلص : حافظ على نزاهتك وصدقك؛ فاستعادة السمعة المفقودة أصعب بكثير من الحفاظ عليها.",
            "❓ سؤال للتأمل : ما هي الحدود الأخلاقية التي تتعهد أمام نفسك بألا تتخطاها أبداً مهما كانت الإغراءات؟",
            "--- اقتباس رقم 18 ---",
            "\"قراءة الكتب الجيدة كالحوار مع عظماء العصور الماضية.\"",
            "✒️ الشرح : القراءة تفتح باباً مباشرًا لعقول الفلاسفة والعلماء عبر التاريخ، وتختصر عليك سنوات من التجارب والأخطاء.",
            "☀️ الدرس المستخلص : اجعل القراءة اليومية غذاء لعقلك لتوسيع مداركك والاستفادة من حكمة الأجيال السابقة.",
            "❓ سؤال للتأمل : ما هو الكتاب الذي غير نظرتك للحياة بشكل كامل، وكيف أثر في قراراتك",
            "--- اقتباس رقم 19 ---",
            "\"الفن هو الطريقة الوحيدة للهروب من عبودية الرغبة اللامتناهية.\"",
            "✒️ الشرح : التأمل الجمالي في اللوحات والموسيقى يفصل عقولنا عن السعي الدائم وراء إرضاء الرغبات، ويمنحنا سكينة روحية مؤقتة.",
            "☀️ الدرس المستخلص : امنح نفسك لحظات للتأمل الفني والموسيقي لتهدئة ضغوط السعي اليومي المستمر.",
            "❓ سؤال للتأمل : كيف تؤثر الموسيقى أو الفنون البصرية في حالتك المزاجية وقدرتك على الاسترخاء؟",
            "--- اقتباس رقم 20 ---",
            "\"الحكيم لا يبحث عن اللذة، بل يبحث عن الخلو من الألم.\"",
            "✒️ الشرح : مطاردة اللذات المتطرفة تنتهي غالباً بالندم والألم. الحكمة تكمن في الحفاظ على حياة هادئة ومتوازنة خالية من الاضطرابات.",
            "☀️ الدرس المستخلص : اختر السلام المستقر والهدوء النفسي على الإثارة المؤقتة واللذات العابرة.",
            "❓ سؤال للتأمل : هل تبحث في حياتك عن الإثارة والشهوات اللحظية، أم تسعى لبناء سلام دائم ومستقر؟",
            "يمكنكم تحميل المستند بالكامل بصيغة وورد (.docx) القابلة للتعديل والطباعة بالضغط على زر التحميل أدناه، أو عبر إضافته إلى سلتكم مجاناً في المتجر."
          ]
        }
      ],
      "faq": [
