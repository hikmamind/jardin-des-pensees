...
function populateArticles(category = 'all', keyword = '') {
  ...
  if (articles.length === 0) {
    ...
    container.innerHTML = articles.map((art, index) => {
      ...
      ` : `
        <div class="article-image-container" style="display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, rgba(223, 177, 91, 0.03), rgba(52, 211, 153, 0.05));">
      ...
      return `
        <div class="article-card">
          ${imageHtml}
          <span class="article-meta" style="margin-top: 5px;">${art.readTime}</span>
