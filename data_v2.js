  ...
  content: {
    fr: {
      ...
      advices: [
        ...
        { category: "Développement", title: "L'Effet Cumulé des Habitudes", icon: "trending-up", desc: "S'améliorer de seulement 1% chaque jour produit des résultats 37 fois supérieurs au bout d'un an. Soyez régulier.", thinker: "James Clear" }
      ],
      thinkers: [
        { id: "schopenhauer", name: "Arthur Schopenhauer", era: "1788 - 1860", school: "Pessimisme", bio: "Philosophe allemand connu pour sa théorie du vouloir-vivre comme essence métaphysique du monde et son influence sur le concept d'art." },
        { id: "nietzsche", name: "Friedrich Nietzsche", era: "1844 - 1900", school: "Existentialisme / Vitalisme", bio: "Célèbre pour sa critique de la morale traditionnelle, son concept de surhomme, de la volonté de puissance et de l'éternel retour." },
        { id: "camus", name: "Albert Camus", era: "1913 - 1960", school: "Absurdisme", bio: "Écrivain et philosophe français, lauréat du prix Nobel, auteur de 'L'Étranger' et du 'Mythe de Sisyphe' traitant de l'absurde." },
        { id: "marcaurele", name: "Marc Aurèle", era: "121 - 180 ap. J.-C.", school: "Stoïcisme", bio: "Empereur romain et philosophe, auteur des 'Pensées pour moi-même', guide intemporel de résilience et de discipline intérieure." },
        { id: "seneque", name: "Sénèque", era: "4 av. J.-C. - 65 ap. J.-C.", school: "Stoïcisme", bio: "Conseiller impérial et écrivain romain, connu pour ses lettres sur la brièveté de la vie, la mort et le contrôle des passions." },
        { id: "kant", name: "Emmanuel Kant", era: "1724 - 1804", school: "Idéalisme Allemand / Criticisme", bio: "L'un des plus grands penseurs des Lumières, connu pour ses examens de la raison pure, de la raison pratique et de l'éthique déontologique." },
        { id: "hegel", name: "G. W. F. Hegel", era: "1770 - 1831", school: "Idéalisme Allemand", bio: "Créateur d'un système philosophique dialectique global cherchant à comprendre l'évolution dialectique de l'Histoire et de l'Esprit." }
      ],
      articles: [
        {
          category: "philosophy",
        ...
        },
        {
          ...
          body: [
            ...
            "Le refoulement de l'ombre ne signifie pas sa disparition ; elle se manifeste de manière inconsciente sous forme de colère, de culpabilité ou de projection sur les autres. Jung écrivait : 'Jusqu'à ce que vous rendiez l'inconscient conscient, il dirigera votre vie et vous l'appellerez destin.'",
        ...
        },
        {
          ...
          readTime: "8 min read",
          desc: "Un voyage passionnant à travers le temps pour comprendre comment notre conception du bien et du mal a évolué.",
          body: [
    ...
    en: {
      ...
      videos: [
        { id: "vid1", title: "Marcus Aurelius: 3 stoic maxims to stay calm under criticism 🏛️", views: "1.2M", likes: "250K", duration: "01:24", tags: ["#stoicism", "#calm"], youtubeId: "dQw4w9WgXcQ" },
      ...
      thinkers: [
        { id: "schopenhauer", name: "Arthur Schopenhauer", era: "1788 - 1860", school: "Pessimism", bio: "German philosopher best known for his theory of the will-to-live as the metaphysical essence of the world and his pessimistic stance." },
        { id: "nietzsche", name: "Friedrich Nietzsche", era: "1844 - 1900", school: "Existentialism / Vitalism", bio: "Famous for his critique of traditional morality, his concept of the Overman, the will to power, and eternal recurrence." },
        { id: "camus", name: "Albert Camus", era: "1913 - 1960", school: "Absurdism", bio: "French writer and philosopher, Nobel laureate, author of 'The Stranger' and 'The Myth of Sisyphus' dealing with the absurdity of existence." },
        { id: "marcaurele", name: "Marcus Aurelius", era: "121 - 180 AD", school: "Stoicism", bio: "Roman Emperor and philosopher, author of 'Meditations', a timeless blueprint for inner resilience and self-discipline." },
        { id: "seneque", name: "Seneca", era: "4 BC - 65 AD", school: "Stoicism", bio: "Imperial advisor and playwright, famous for his essays on the shortness of life, death, and mastering the passions." },
        { id: "kant", name: "Immanuel Kant", era: "1724 - 1804", school: "German Idealism / Criticism", bio: "One of the greatest Enlightenment thinkers, known for his critical examinations of pure reason, practical reason, and ethics." },
        { id: "hegel", name: "G. W. F. Hegel", era: "1770 - 1831", school: "German Idealism", bio: "Creator of a comprehensive dialectical philosophy aimed at understanding the evolutionary progression of History and Spirit." }
      ],
      articles: [
        {
          category: "philosophy",
    ...
    ar: {
      ...
      thinkers: [
        { id: "schopenhauer", name: "أرتور شوبنهاور", era: "1788 - 1860", school: "التشاؤمية", bio: "فيلسوف ألماني شهير بنظريته حول إرادة الحياة باعتبارها الجوهر الميتافيزيقي للعالم وموقفه المتشائم." },
        { id: "nietzsche", name: "فريدريك نيتشه", era: "1844 - 1900", school: "الوجودية / الحيوية", bio: "اشتهر بنقده اللاذع للأخلاق والقيم التقليدية، ومفهوم الإنسان المتفوق، وإرادة القوة والعود الأبدي." },
        { id: "camus", name: "ألبير كامو", era: "1913 - 1960", school: "العبثية", bio: "كاتب وفيلسوف فرنسي حائز على جائزة نوبل، صاحب رواية 'الغريب' و'أسطورة سيزيف' اللتين تجسدان العبث البشري." },
        { id: "marcaurele", name: "ماركوس أوريليوس", era: "121 - 180 م", school: "الرواقية", bio: "إمبراطور روماني وفيلسوف، كاتب 'التأملات' التي تمثل دليلاً عملياً خالداً لبناء المرونة والصلابة النفسية." },
        { id: "seneque", name: "سينيكا", era: "4 ق.م - 65 م", school: "الرواقية", bio: "مستشار إمبراطور وكاتب روماني، اشتهر برسائله في قصر الحياة، ومواجهة الموت والتحكم في المشاعر." },
        { id: "kant", name: "إيمانويل كانط", era: "1724 - 1804", school: "المثالية الألمانية / النقدية", bio: "أحد أعظم مفكري عصر التنوير، عرف بأبحاثه النقدية للعقل الخالص والعقل العملي والمنظومة الأخلاقية والواجب." },
        { id: "hegel", name: "جورج هيغل", era: "1770 - 1831", school: "المثالية الألمانية", bio: "مؤسس نظام فلسفي جدلي متكامل يسعى لتفسير التطور التاريخي والروحي وحركة الفكر والوجود البشري." }
      ],
      articles: [
        {
          category: "philosophy",
        ...
        },
        {
          ...
          body: [
            ...
            "المبدأ الأول: ميّز بين ما تستطيع التحكم فيه وما لا تستطيع. يُعد هذا المبدأ أساس الفلسفة الرواقية. هناك أمور تقع تحت سيطرتك مثل أفكارك وقراراتك وأفعالك وأخلاقك. وهناك أمور لا يمكنك التحكم بها مثل آراء الناس والماضي والمستقبل والمرض والطقس وتصرفات الآخرين. الرواقي الحكيم لا يهدر طاقته في مقاومة ما لا يستطيع تغييره، بل يركز على ما يستطيع تحسينه.",
