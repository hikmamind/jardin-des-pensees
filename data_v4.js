    ...
    fr: {
      ...
      thinkers: [
        ...
        },
        {
          ...
          body: [
            "Friedrich Nietzsche (1844 - 1900) est l'un des penseurs les plus révolutionnaires du XIXe siècle. Il a critiqué de manière radicale la morale traditionnelle, la religion et la métaphysique occidentale, ouvrant la voie à l'existentialisme.",
    ...
    ar: {
      ...
      articles: [
        ...
        },
        {
          ...
          body: [
            "غالباً ما نعتقد أن إحداث تغييرات كبيرة في حياتنا يتطلب قرارات ضخمة ومجهوداً خارقاً. ولكن الحقيقة تكمn في سيكولوجية العادات الصغيرة أو 'العادات الذرية' كما يسميها جيمس كلير.",
