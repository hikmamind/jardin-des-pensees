const TIKTOK_DATA = {
  ...
  ui: {
    ...
    ar: {
      ...
      shopSubtitle: "مصادر وقراءات ومقتنيات حكمة لتطبيق الفلسفة in حياتك اليومية.",
      ...
      quiz: {
        ...
        profiles: {
          stoic: {
            ...
            recomThinkers: ["marcaurele", "seneque"],
          ...
          existential: {
            ...
            recomThinkers: ["nietzsche", "schopenhauer"],
      ...
      thinkers: [
        ...
        },
        {
          ...
          body: [
            ...
            "اتُهم سينيكا زوراً بالتآمر ضد نيرون، فتلقى أمراً إمبراطورياً بإنهاء حياته. واجه الموت بهدوء رواقي أسطوري، حيث قام بقطع شرايينه وتناول السم محاطاً بأشخاص يحبهم، مقدماً بذلك تطبيقاً عملياً خالداً لفلسفته في مواجهة المصير بكل شjاعة."
          ]
        },
        {
          id: "camus",
          ...
          body: [
            ...
            "يرى كامو أن إدراك عبثية الحياة لا يجب que يقود إلى اليأس أو الانتحار، بل إلى التمرد والحرية المطلقة وعيش اللحظة بشغف. في كتابه 'الإنسان المتمرد'، يوضح أن مواجهة غياب المعنى والوقوف ضد الظلم هما ما يمنحان قيمة حقيقية لحياتنا. صاغ مقولته الشهيرة: 'أنا أتمرد، إذن نحن موجودون'، واضعاً أسس نزعة إnsانية ترفض الاستسلام.",
      ...
      quiz: {
        ...
        profiles: {
          stoic: {
            ...
            desc: "تتلاقى روحك وتفكيرك مع الفلاسفة الكبار مثل ماركوس أوريليوس وسينيكا. أنت تمتلك قوة داخلية تنبع من التمييز الواضح بين ما يمكنك تغييره وما يجب عليك قبوله. صلابتك أمام تقلبات الحياة هي أعظم درع تحمله.",
            recomThinkers: ["marcaurele", "seneque"],
            recomCategory: "philosophy"
          },
          absurd: {
          ...
          existential: {
            ...
            desc: "أنت تشارك فريدريك نيتشه وأرتور شوبنهاور نظرتهما للوجود. بالنسبة لك، تمثل الحياة مساراً مستمراً لتجاوز الذات وتطوير الوعي النفسي. أنت لا تخشى مواجهة الجوانب المظلمة لتصنع منها حريتك وقوتك الفريدة.",
            recomThinkers: ["nietzsche", "schopenhauer"],
            recomCategory: "development"
          }
        }
