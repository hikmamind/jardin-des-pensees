import TIKTOK_DATA from './data_v5.js';
...
if (!localStorage.getItem('lang_force_ar_v5')) {
  localStorage.setItem('lang', 'ar');
  localStorage.setItem('lang_force_ar_v5', 'true');
}
    ...
    return `
      <div class="thinker-card">
        <div class="thinker-header">
          <div class="thinker-avatar-placeholder" style="width: 50px; height: 50px; border-radius: 50%; overflow: hidden; border: 2px solid var(--accent-gold); flex-shrink: 0; background: none; display: flex; align-items: center; justify-content: center;">
